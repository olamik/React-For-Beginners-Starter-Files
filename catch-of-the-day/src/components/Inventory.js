	...
	render() {
		...
		return (
			<div className="inventory">
				<h2>Inventory</h2>
				{Object.keys(this.props.fishes).map(key => <EditFishForm index={key} deleteFish={this.props.deleteFish} updateFish={this.props.updateFish} key={key} fish={this.props.fishes[key]}/>)}
